                        ...
                        <div class="5grid">
                            ...
                            <div class="row">
                                <div class="6u">
                                    ...
                                    <%--Validator for fName--%>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please enter the first name" ControlToValidate="fName"></asp:RequiredFieldValidator>
                                </div>
                                <div class="6u">
